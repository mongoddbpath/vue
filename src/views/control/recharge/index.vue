...
<!-- 手动扣减dialog -->
    ...
    <el-row style="margin-top:12px;">
      ...
      <el-button type="success" icon="el-icon-plus" @click="dialogFormVisible2 = true">在线充值</el-button>
...
import RechargeStatusTag from '@/components/RechargeStatusTag'
// 引入前往站点排名组件
...
export default {
  ...
  data () {
    return {
      ...
      pagination: {
        background: true,
        currentPage: parseInt(localStorage.getItem('rechargecontrolcurrentPage')) || 1,
        pageSize: 15,
        total: 12
      },
      columns: [
  ...
  mounted () {
    ...
    let getcurrentPage = parseInt(localStorage.getItem('rechargecontrolcurrentPage')) || 1
  ...
  methods: {
    ...
    fetchData () {
      ...
      rechargelist(this.pagination.currentPage).then(res => {
    ...
    paginationCurrentChange (currentPage) {
      ...
      localStorage.setItem('rechargecontrolcurrentPage', currentPage)
      this.fetchData()
    },
    // 前往创建站点
    gotowebs () {
